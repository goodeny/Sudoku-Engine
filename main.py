...
class App:
    ...
    def windows_blocks(self):
        self.w_blocks = Frame(self.window, height=550, width=613, bg='#373941')
    ...
    def generate_buttons(self):
        ...
        self.button_pad = Button(self.window,image=self.button_pad_img1, text=1, bd= 0, command=lambda: self.input_number(1))
        self.button_pad.place(x=x1,y=y1)

        self.button_pad = Button(self.window,image=self.button_pad_img2, bd= 0, command=lambda: self.input_number(2))
        self.button_pad.place(x=x1+100,y=y1)

        self.button_pad = Button(self.window,image=self.button_pad_img3, bd= 0, command=lambda: self.input_number(3))
        self.button_pad.place(x=x1+200,y=y1)

        self.button_pad = Button(self.window,image=self.button_pad_img4, bd= 0, command=lambda: self.input_number(4))
        self.button_pad.place(x=x1,y=y1+100)

        self.button_pad = Button(self.window,image=self.button_pad_img5, bd= 0, command=lambda: self.input_number(5))
        self.button_pad.place(x=x1+100,y=y1+100)

        self.button_pad = Button(self.window,image=self.button_pad_img6, bd= 0, command=lambda: self.input_number(6))
        self.button_pad.place(x=x1+200,y=y1+100)

        self.button_pad = Button(self.window,image=self.button_pad_img7, bd= 0, command=lambda: self.input_number(7))
        self.button_pad.place(x=x1,y=y1+200)

        self.button_pad = Button(self.window,image=self.button_pad_img8, bd= 0, command=lambda: self.input_number(8))
        self.button_pad.place(x=x1+100,y=y1+200)

        self.button_pad = Button(self.window,image=self.button_pad_img9, bd= 0, command=lambda: self.input_number(9))
